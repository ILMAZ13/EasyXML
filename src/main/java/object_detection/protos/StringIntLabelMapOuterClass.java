    ...
    public static final class StringIntLabelMapItem extends
        ...
        public static final class Builder extends
            ...
            public Builder mergeFrom(object_detection.protos.StringIntLabelMapOuterClass.StringIntLabelMapItem other) {
                if (other == object_detection.protos.StringIntLabelMapOuterClass.StringIntLabelMapItem.getDefaultInstance())
                    return this;
                if (other.hasName()) {
                    bitField0_ |= 0x00000001;
                    name_ = other.name_;
    ...
    public static final class StringIntLabelMap extends
        ...
        public static final class Builder extends
            ...
            public Builder mergeFrom(object_detection.protos.StringIntLabelMapOuterClass.StringIntLabelMap other) {
                if (other == object_detection.protos.StringIntLabelMapOuterClass.StringIntLabelMap.getDefaultInstance())
                    return this;
                if (itemBuilder_ == null) {
            ...
            public Builder addAllItem(
                    Iterable<? extends object_detection.protos.StringIntLabelMapOuterClass.StringIntLabelMapItem> values) {
                if (itemBuilder_ == null) {
                    ensureItemIsMutable();
